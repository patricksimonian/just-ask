...
const Shpeel = () => (
  <WidthControlledContainer>
    ...
    <Text as="h2" fontWeight={400} fontSize={[5,4,5]} mb={3} maxWidth={800}>
    ...
    <Text as="h2" fontWeight={400} fontSize={[5,4,5]} mb={3} maxWidth={800}>Github Org Management can be painful</Text>
    <Text as="p" mb={8} maxWidth={800}> The role-based access structure of github is basic. It doesn't provide a means of granting certain users access to administering invite membership without giving the keys to castle.
    </Text>
    
    <Text as="h2" fontWeight={400} fontSize={[5,4,5]} mb={3} maxWidth={800}><Text as="em" color="secondary" fontStyle="normal">Just Ask!</Text> extends the basic role based access of your github orgs</Text>
    <Text as="p" mb={8} maxWidth={800}>
    ...
    <Text  as="h2" fontWeight={400} fontSize={[5,4,5]} mb={3} maxWidth={800}>It's as easy as <Text as="em" color="secondary" fontStyle="normal">Just Asking!</Text></Text>
    <Text as="p" mb={8} maxWidth={800}>
